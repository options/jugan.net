...
이번 주 On .NET 쇼에서는 11/07 부터 진행된  MVP 서밋에 참여한 전세계 MVP들과 짤막한 인터뷰를 중 하나를 보내드릴 예정인데 Mitch Muenster와 "being a developer with autism(자페를 가진 개발자로 살아가기)" 라는 주제로 진행했습니다.
